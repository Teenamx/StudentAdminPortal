...
namespace StudentAdminPortal.Api.Repositories
{
    public class SqlStudentRepository : IStudentRepository
    {
        ...
        public async Task<Student> GetStudentDetailAsync(Guid studentId)
        {
        ...
        {
            var existingStudent = await GetStudentDetailAsync(studentId);
        ...
        {
            var student = await GetStudentDetailAsync(studentId);
            if(student!=null)
            {
